...
def prepare():
    ...
    patches.append(ROOT / "scripts/patches/bridge-rsapss.patch")
    patches.append(ROOT / "scripts/patches/bridge-dhe-chacha.patch")
    ...
    patches.append(ROOT / "scripts/patches/bridge-char2.patch")
